...
export const UNIT_DATA: Record<UnitKind, UnitDataEntry> = {
  worker: {
    ...
    cost: { gold: 75, lumber: 0 }, supply: 1, trainTime: 50,
  ...
  footman: {
    ...
    cost: { gold: 135, lumber: 0 }, supply: 1, trainTime: 60,
    trainedAt: ['barracks'],
    requires: [],
  ...
  archer: {
    ...
    cost: { gold: 150, lumber: 50 }, supply: 1, trainTime: 70,
    trainedAt: ['barracks'],
  ...
  knight: {
    ...
    cost: { gold: 250, lumber: 100 }, supply: 1, trainTime: 90,
    trainedAt: ['stable'],
    requires: [],
    orders: ['move', 'stop', 'attack', 'patrol', 'hold_position'],
    isWorker: false,
  ...
  ballista: {
    ...
    cost: { gold: 250, lumber: 300 }, supply: 1, trainTime: 120,
    trainedAt: ['barracks'],
    requires: [['blacksmith']],
    orders: ['move', 'stop', 'attack', 'patrol', 'hold_position'],
    isWorker: false,
  ...
  cleric: {
    ...
    sightRange: 6000, collisionRadius: 350,
    cost: { gold: 200, lumber: 0 }, supply: 1, trainTime: 80,
    trainedAt: ['barracks'],
    requires: [['lumber_mill']],
    orders: ['move', 'stop', 'attack', 'patrol', 'hold_position'],
    isWorker: false,
